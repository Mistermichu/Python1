...
while run == True:
    ...
    while poprawnosc_danych == False:
        ...
        checkpoint_1 = False
        while checkpoint_1 == False:
            print("Czy podane wartosci sa poprawne?")
            print("Tak - wprowadz: Y")
            print("Nie - wprowadz: N")
            poprawnosc_danych_input = input("").upper()

            if poprawnosc_danych_input == "Y":
                poprawnosc_danych = True
                checkpoint_1 = True
            elif poprawnosc_danych_input == "N":
                poprawnosc_danych = False
                checkpoint_1 = True
            else:
                print("Blad, odpowiedz ponownie")
    ...
    checkpoint_2 = False
    while checkpoint_2 == False:

        print("Czy uruchomic program ponownie?")
        print("Tak - wprowadz: Y")
        print("Nie - wprowadz: N")
        run_input = input("").upper()
